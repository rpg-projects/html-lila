export const charlieHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const elodieHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const carcinhaHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const jackieHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const oliviaHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const hughieHTML = `<center>
<div
  style="
    width: 650px;
    margin: 14px;
...
export const matthewHTML = `<center><div style="width:650px; margin: 14px; background-color: #3b0707; color: #fff; font-family: 'century gothic'; font-size: 10px;">  
...
export const emilyHTML = `<center style="font-family: Tahoma">
  <div
    style="
      margin-top: 40px;
      width: 650px;
